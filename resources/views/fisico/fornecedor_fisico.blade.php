    ...
    <form action="{{ route('fornecedor_fisico.store') }}" method="POST">
                ...
                <nav class="nav-extended">
                    ...
                    <ul class="tabs tabs-transparent">
                        ...
                        <li class="tab"><a class="fornecedor" href="fornecedor_juridico">Fornecedor Juridico</a></li>
                        <li class="tab"><a class="fornecedor" href="fornecedor_fisico">Fornecedor Físico</a></li>
                    </ul>
                    </div>
                </nav>
